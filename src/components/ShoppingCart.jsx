...
const ShoppingCart = ({ onAdd, onRemove, onDelete, cartItems }) => {
    ...
    return (
        <section className="px-4 py-5 w-100 p-3 mb-5 rounded" style={{ backgroundColor: "#ffffff", borderRadius: ".5rem .5rem 0 0" }}>

            <div className="row">
                <div className="col-12">
                    <div className="card card-registration card-registration-2 shadow" style={{ borderRadius: 15 }}>
